...
public class ModifierListeCoursesController {
	...
	public String afficher(final ModelMap pModel) {
		if (pModel.get("modification") == null) {
			...
			final List<ModificationCourse> lListe = new
					LinkedList<ModificationCourse>();
			for (final Course lCourse : lListeCourses) {
				final ModificationCourse lModificationCourse = new
						ModificationCourse();
	...
	public String modifier(@Validated @ModelAttribute(value="modification") final ModificationForm pModification,final BindingResult pBindingResult, final ModelMap pModel) {
